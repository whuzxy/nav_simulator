...
#include "PriusHybridPlugin_4w.hh"
...
void PriusHybridPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  this->dataPtr->node.Subscribe("/cmd_vel3", &PriusHybridPlugin::OnCmdVel, this);
  this->dataPtr->node.Subscribe("/cmd_vel2", &PriusHybridPlugin::OnmyCmdVel, this);
...
void PriusHybridPlugin::OnmyCmdVel(const ignition::msgs::Any &_msg)
{ROS_INFO("mycmd_vel");
